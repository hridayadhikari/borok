    ...
    <footer style={{ backgroundColor: 'var(--surface-cream)', marginTop: '4rem', borderTop: '1px solid var(--border-hairline)' }}>
      ...
      <div className="container" style={{ padding: '2.5rem 1rem 1.5rem 1rem' }}>
        ...
        <div style={{
          ...
          <div>
            © {new Date().getFullYear()} Borok / Tripura Language Preservation. Mobile-first, low-bandwidth optimized.
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
            <span>Crafted with</span>
            <Heart size={14} fill="var(--accent-maroon)" color="var(--accent-maroon)" />
            <span>for the Borok people & global learners</span>
          </div>
        </div>

        {/* Maker's Mark / Persistent Creator Credit Section */}
        <div style={{ marginTop: '1.5rem', paddingTop: '1rem', borderTop: '1px solid var(--border-hairline)' }}>
          <div className="creator-credit-bar">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              />
              <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.88rem', color: '#5A4E3F', fontWeight: '600' }}>
                Built by Hriday Adhikari
              </span>
            </div>

            {/* Right: 3 Icon Links (1. Instagram, 2. GitHub, 3. Personal Website) */}
